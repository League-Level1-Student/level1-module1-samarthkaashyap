...
public class TurfWar extends PApplet {
    ...
    public void setup() {
        ...
        player1 = new Player(100, 200, 10, 20, Color.blue.getRGB(), KeyEvent.VK_UP, KeyEvent.VK_DOWN, KeyEvent.VK_LEFT, KeyEvent.VK_RIGHT);
        player2 = new Player(100, 200, 10, 20, Color.red.getRGB(), KeyEvent.VK_W, KeyEvent.VK_S, KeyEvent.VK_A, KeyEvent.VK_D);
